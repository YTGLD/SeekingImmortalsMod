    ...
    public void registerRecipes(IRecipeRegistration registration) {
        {
            ...
            registration.addIngredientInfo(new ItemStack(Items.bone_or_god.get()), VanillaTypes.ITEM_STACK, Component.translatable("seeking_immortals.jei.item.seeking_immortals.bone_or_god").append(Component.translatable("seeking_immortals.jei.item.seeking_immortals.nightmare_base.all").append(Component.translatable("item.seeking_immortals.nightmare_base"))));
            registration.addIngredientInfo(new ItemStack(Items.blood_ring.get()), VanillaTypes.ITEM_STACK, Component.translatable("seeking_immortals.jei.item.seeking_immortals.blood_ring").append(Component.translatable("seeking_immortals.jei.item.seeking_immortals.nightmare_base.all").append(Component.translatable("item.seeking_immortals.nightmare_base"))));
            registration.addIngredientInfo(new ItemStack(Items.biochemistry.get()), VanillaTypes.ITEM_STACK, Component.translatable("seeking_immortals.jei.item.seeking_immortals.biochemistry").append(Component.translatable("seeking_immortals.jei.item.seeking_immortals.nightmare_base.all").append(Component.translatable("item.seeking_immortals.nightmare_base"))));
            registration.addIngredientInfo(new ItemStack(Items.crazy_drug.get()), VanillaTypes.ITEM_STACK, Component.translatable("seeking_immortals.jei.item.seeking_immortals.crazy_drug").append(Component.translatable("seeking_immortals.jei.item.seeking_immortals.nightmare_base.all").append(Component.translatable("item.seeking_immortals.nightmare_base"))));
            ...
            registration.addIngredientInfo(new ItemStack(Items.muddy_jewels.get()), VanillaTypes.ITEM_STACK, Component.translatable("seeking_immortals.jei.item.seeking_immortals.muddy_jewels").append(Component.translatable("seeking_immortals.jei.item.seeking_immortals.nightmare_base.all")
                    .append(Component.translatable("item.seeking_immortals.nightmare_base_black_eye"))));
