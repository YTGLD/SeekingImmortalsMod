...
public class EntityTs {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<lotus_entity>> lotus_entity = REGISTRY.register("lotus_entity",
            () -> EntityType.Builder.of(lotus_entity::new, MobCategory.MISC).sized(0.1F, 0.1F).clientTrackingRange(50).build("lotus_entity"));
}
